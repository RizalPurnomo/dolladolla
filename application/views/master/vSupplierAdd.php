...
<script type="text/javascript">
    function saveSupplier() {
        ...
        $.ajax({
            type: "POST",
            data: dataArray,
            url: '<?php echo base_url('supplier/saveData'); ?>',
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="idsupplier" disabled placeholder="Id Customer" value="<?php echo $idSupplier; ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Nama Supplier</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="namasupplier" placeholder="Nama Customer">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="tlp" placeholder="Telp">
                                    </div>
                                </div>
                                <div class="form-group row">
