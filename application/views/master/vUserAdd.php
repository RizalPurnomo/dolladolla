                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="iduser" value="<?php echo $iduser; ?>" disabled placeholder="User Id">
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                <button onclick="saveUser()" class="btn btn-info">Simpan</button>
